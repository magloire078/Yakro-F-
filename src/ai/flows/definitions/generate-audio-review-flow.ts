...
export const GenerateAudioReviewInputSchema = z.object({
    reviews: z.array(
        z.object({
...
export const GenerateAudioReviewOutputSchema = z.object({
...
export const generateAudioReviewFlow = ai.defineFlow(
    {
