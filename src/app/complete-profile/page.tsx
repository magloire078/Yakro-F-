          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-12 rounded-2xl border-border/50 bg-background/50 focus-visible:ring-primary/30 focus-visible:border-primary/50"
                {...form.register('nom')}
                disabled={isSaving}
              />
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                disabled={isSaving}
              >
                <SelectTrigger id="role" className="h-12 w-full rounded-2xl border-border/50 bg-background/50 focus:ring-primary/30">
            ...
            <div className="space-y-2">
              <Label htmlFor="codeParrainage" className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Code de parrainage (optionnel)</Label>
              <Input
                id="codeParrainage"
