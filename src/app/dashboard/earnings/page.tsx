    ...
    return (
        <DashboardPage
            heroProps={{
                ...
                title: <>Mes <span className="text-primary italic">Revenus</span></>,
                        ...
                        >
                            ...
                            <div className="flex justify-between items-start mb-8">
                                ...
                                <div className={cn(
                                    ...
                                    item.color === 'orange' ? 'bg-primary/10 text-primary' : 'bg-white/5 text-muted-foreground'
                                )}>
                                            ...
                                            {myCompletedDeliveries.map((order, index) => (
                                                ...
                                                >
                                                    ...
                                                    <TableCell className="text-right py-4 md:py-6">
                                                        <span className="text-2xl md:text-3xl font-black italic tracking-tighter text-primary">
