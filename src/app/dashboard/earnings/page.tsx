            ...
            <div className="relative h-[45vh] w-full overflow-hidden flex items-center justify-center pt-16">
                ...
                <div className="relative z-30 text-center space-y-6 px-6 max-w-4xl">
                    <motion.div 
                        ...
                        className="inline-flex items-center gap-2 px-4 py-1.5 bg-primary/10 border border-primary/20 backdrop-blur-md mb-2"
                    >
                        <ShieldCheck className="h-4 w-4 text-primary" />
                        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-primary">Elite Certified Status</span>
                    </motion.div>
                    ...
                    >
                        Mes <span className="text-primary">Revenus</span>
                    </motion.h1>
            ...
            <div className="container mx-auto px-6 max-w-7xl -mt-16 relative z-40 space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        <motion.div 
                            ...
                            className="group bg-[#121214]/80 backdrop-blur-xl border border-white/5 p-8 relative overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:border-primary/20"
                        >
                            <div className="absolute top-0 left-0 w-1 h-full bg-primary opacity-0 group-hover:opacity-100 transition-opacity" />
                            <div className="flex justify-between items-start mb-8">
                                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-600 group-hover:text-primary transition-colors">{item.label}</span>
                                <div className={`p-3 ${item.color === 'orange' ? 'bg-primary/10 text-primary' : 'bg-white/5 text-gray-500'} transition-transform duration-500`}>
                                    <item.icon className="h-5 w-5" />
                                </div>
                            </div>
                            <div className="flex items-baseline gap-2">
                                <span className={`text-5xl font-black italic tracking-tighter ${item.color === 'orange' ? 'text-primary' : 'text-white'}`}>
                ...
                >
                    <div className="flex items-center justify-between mb-12">
                        <div>
                            <h2 className="text-3xl font-black italic uppercase tracking-tighter text-white">Journal des <span className="text-primary">Missions</span></h2>
                            ...
                            <div className="relative">
                                                ...
                                                >
                                                    ...
                                                    <TableCell className="py-8">
                                                        <div className="flex items-center gap-4">
                                                            <div className="h-12 w-12 bg-white/5 flex items-center justify-center border border-white/10 group-hover:border-primary/30 transition-colors">
                                                    ...
                                                    <TableCell className="py-8 text-center">
                                                        <Badge className="rounded-none bg-primary/10 text-primary border border-primary/20 px-4 py-1 font-black italic text-[10px] tracking-tight uppercase">
                                                            Validée
                                                        </Badge>
                                                    </TableCell>
                                ...
                                <div className="md:hidden space-y-6">
                                    {myCompletedDeliveries.map((order, index) => (
                                        ...
                                        >
                                            <div className="absolute top-0 left-0 w-full h-[1px] bg-primary/0 group-hover:bg-primary/30 transition-colors" />
                                            <div className="flex justify-between items-start mb-6">
                                                ...
                                                <Badge className="rounded-none bg-primary/10 text-primary border border-primary/20 px-3 py-0.5 font-black italic text-[8px] tracking-tight uppercase">
                                                    Validée
                                                </Badge>
                                            </div>
