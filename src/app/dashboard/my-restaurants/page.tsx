    ...
    return (
        <DashboardPage
            heroProps={{
                ...
                title: <>Mes <span className="text-primary italic">Établissements</span></>,
        ...
        >
                                    ...
                                    <div className="relative h-24 md:h-40 w-full overflow-hidden">
                                        ...
                                        {restaurant.enVedette && (
                                            <div className="absolute top-2.5 md:top-6 right-3 md:right-6">
                                                <div className="h-6 w-6 md:h-10 md:w-10 bg-primary flex items-center justify-center rounded-lg md:rounded-2xl shadow-[0_0_20px_rgba(249,115,22,0.6)]">
            ...
            <div className="hidden md:flex justify-center mt-8">
                <Button asChild className="h-14 px-12 bg-primary hover:bg-primary/90 text-white rounded-2xl font-black italic uppercase tracking-tighter text-lg shadow-[0_20px_40px_rgba(249,115,22,0.2)] transition-all duration-500 hover:scale-105 active:scale-95 group">
                        ...
                        <AlertDialogDescription className="text-slate-400 font-medium pt-3 md:pt-4 text-sm md:text-base leading-relaxed italic">
                            {restaurantToDelete && menuItems.some(p => p.restaurantId === restaurantToDelete.id) ? (
                                <>
                                    ...
                                    <span className="block mt-3 md:mt-4 text-primary font-bold uppercase tracking-widest text-[10px] md:text-xs">Veuillez purger le menu avant de pouvoir dissoudre cet établissement.</span>
                                </>
                            ) : (
                                <>
