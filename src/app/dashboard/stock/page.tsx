        ...
        return (
            <div className="flex h-screen w-full items-center justify-center bg-background">
                <div className="relative">
                    <div className="h-20 w-20 border-2 border-primary/10 border-t-primary rounded-full animate-spin" />
    ...
    return (
        <DashboardPage
            heroProps={{
                ...
                title: <>Contrôle <span className="text-primary italic text-shadow-orange">Inventaire</span></>,
                ...
                <Tabs defaultValue="inventaire" className="w-full">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8 bg-card/40 backdrop-blur-xl border border-white/5 p-2 rounded-3xl shadow-2xl">
                        <TabsList className="bg-white/5 h-12 md:h-14 p-1 w-full md:w-auto rounded-2xl border border-white/5">
                            ...
                            <TabsTrigger 
                                value="courses" 
                                className="flex-1 md:flex-none h-full px-6 rounded-xl font-black italic text-[10px] md:text-xs data-[state=active]:bg-primary data-[state=active]:text-white transition-all flex items-center justify-center gap-2"
                            >
                                Liste
                                {stats.low + stats.critical > 0 && (
                                    <span className="h-4 w-4 bg-white text-primary text-[9px] flex items-center justify-center font-black rounded-full shadow-lg animate-pulse">
                        ...
                        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
                            <DialogTrigger asChild>
                                <Button className="w-full md:w-auto h-12 md:h-14 px-8 bg-primary hover:bg-primary/90 text-white rounded-2xl font-black italic tracking-tight transition-all hover:scale-105 active:scale-95 shadow-xl shadow-primary/20">
                    ...
                    {stocks.some(item => item.quantite <= item.seuilAlerte) && (
                        ...
                        >
                            ...
                            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 relative z-10">
                                <div className="h-14 w-14 bg-primary/10 border border-primary/20 rounded-2xl flex items-center justify-center shadow-inner">
