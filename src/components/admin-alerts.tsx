        ...
        return (
            ...
            >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center text-center space-y-6">
                    <div className="h-20 w-20 bg-primary/10 border border-primary/20 rounded-full flex items-center justify-center mb-2 shadow-[0_0_40px_rgba(249,115,22,0.1)] group-hover:scale-110 transition-transform duration-500">
                        <ShieldCheck className="h-10 w-10 text-primary" />
                    </div>
                    <div className="space-y-2">
                        <h3 className="text-xl font-black italic uppercase tracking-tighter text-white">Périmètre <span className="text-primary">Sécurisé</span></h3>
                ...
                <AnimatePresence mode="popLayout">
                    {alerts.map((alert, idx) => (
                        <motion.div
                            ...
                            className={cn(
                                "group relative p-6 rounded-[2rem] border border-white/5 backdrop-blur-3xl shadow-2xl transition-all duration-500 hover:border-primary/30",
                                alert.type === 'danger' ? "bg-red-500/5" : "bg-primary/5"
                            )}
                        >
                            <div className={cn(
                                "absolute top-0 left-0 w-1 h-full rounded-full opacity-40 group-hover:opacity-100 transition-opacity",
                                alert.type === 'danger' ? "bg-red-500 shadow-[0_0_15px_rgba(239,68,68,0.5)]" : "bg-primary shadow-[0_0_15px_rgba(249,115,22,0.5)]"
                            )} />
                            ...
                            <div className="flex gap-6">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center justify-between mb-2">
                                        <h4 className="font-black text-xs italic uppercase tracking-wider text-white group-hover:text-primary transition-colors">{alert.title}</h4>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <Button variant="outline" size="sm" className="h-9 px-5 bg-white/5 border-white/10 hover:bg-primary hover:text-white hover:border-primary rounded-xl text-[9px] font-black italic uppercase tracking-widest transition-all">
                                            INTERVENIR
                                        </Button>
